...
def training(unary_rules, binary_rules, nts, i):
    try:
        with open('./some_data/training.txt') as f:
            sents = f.readlines()
    except IOError:
...
def read_grammar():    
    ...
    try:
        with open('./some_data/nonterminals.txt') as f:
            nlines = f.readlines()
    except IOError:
    ...
    try:
        with open('./some_data/terminals.txt') as f:
            tlines = f.readlines()
    except IOError:
        pass
    ...
    # grammar supplied
    if os.path.isfile('./some_data/pcfg.txt'):
          with open('./some_data/pcfg.txt') as f:
              lines = f.readlines()
    ...
    # no grammar supplied
        ...
        if os.path.exists('./some_data/pos.txt'):
            with open('./some_data/pos.txt') as f:
                plines = f.readlines()
